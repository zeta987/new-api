...
func TestFilterCandidateIDs(t *testing.T) {
	...
	zhipuV4Filter := dto.ChannelFilter{Kind: dto.FilterAllowedChannelTypes, AllowedChannelTypes: []int{constant.ChannelTypeZhipu_v4}}
	...
	tests := []struct {
		...
		{name: "allowed types keep v4 and reject v3", ids: []int{900006, 900007}, modelName: "glm-5.3-high", filters: []dto.ChannelFilter{zhipuV4Filter}, wantKept: []int{900007}},
		{name: "allowed types fail closed for missing cache entry", ids: []int{999999}, modelName: "glm-5.3-high", filters: []dto.ChannelFilter{zhipuV4Filter}, wantKept: []int{}, wantEmpty: dto.FilterAllowedChannelTypes},
		{
