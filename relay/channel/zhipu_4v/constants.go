...
var ModelList = []string{
	...
	"glm-5.2", "glm-5.2-none", "glm-5.2-high", "glm-5.2-max",
	"glm-5.3", "glm-5.3-low", "glm-5.3-high", "glm-5.3-max",
	"glm-5.3-flash", "glm-5.3-flash-low", "glm-5.3-flash-high", "glm-5.3-flash-max",
}
