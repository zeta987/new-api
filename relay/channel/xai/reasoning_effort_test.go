...
func TestGrokReasoningEffortChatAliases(t *testing.T) {
	tests := []struct {
		...
		{alias: "grok-4.0-low", model: "grok-4.0", effort: "low"},
		{alias: "grok-4.4-high", model: "grok-4.4", effort: "high"},
...
func TestGrokReasoningEffortChatLeavesUnsupportedAliasesUnchanged(t *testing.T) {
	aliases := []string{
		...
		"grok-4.7-preview-high",
		"grok-4.7-latest-xhigh",
		"grok-4.7-20260922-high",
		"grok-4.7-search-xhigh",
		"grok-4.7-reasoning-high",
		"grok-4.7-multi-agent-high",
	}
