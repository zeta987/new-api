		...
		if parsed.hasThinking {
			...
			if parsed.intent.BudgetTokens != nil {
				...
				if parsed.intent.Effort != "" {
					request.ReasoningEffort = string(reasoning.OpenAIEffortForModel(parsed.base, parsed.intent.Effort))
				}
			}
	...
	case *dto.OpenAIResponsesRequest:
		...
		if parsed.hasThinking {
			...
			if parsed.intent.Effort != "" {
				...
				request.Reasoning.Effort = string(reasoning.OpenAIEffortForModel(parsed.base, parsed.intent.Effort))
